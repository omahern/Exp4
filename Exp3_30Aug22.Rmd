...
#### qRT PCR
##### C12 T2.5 and 3.5
```{r qpcr_a, fig.height=10,fig.width=10, dpi=300}
...
##### T2.5
###### MC1 vs. MC2
```{r qpcr_1, fig.height=10,fig.width=10, dpi=300}
...
```{r qpcr_2, fig.height=10,fig.width=10, dpi=300}
{
par(mfrow=c(2,2))
plot(MC1_T2.5$Corrected, MC1_T2.5$qPCR_RMAX,type="o", xlab="Buoyant Density - Lueders Corrected",
     ylab="Normalized RNA Conc.", bg='gray70',pch=21, xlim=c(1.735,1.85))
...
###### MC1 vs. MC4
```{r qpcr_3, fig.height=8,fig.width=8, dpi=300}
{
par(mfrow=c(2,2))
plot(MC1_T2.5$Corrected, MC1_T2.5$qPCR_RMAX,type="o", xlab="Buoyant Density - Lueders Corrected",
     ylab="Normalized RNA Conc.", bg='gray70',pch=21, xlim=c(1.735,1.85))
...
```{r qpcr_4, fig.height=8,fig.width=8, dpi=300}
{
par(mfrow=c(2,2))
plot(MC1_T2.5$Corrected, MC1_T2.5$qPCR_RMAX,type="o", xlab="Buoyant Density - Lueders Corrected",
     ylab="Normalized RNA Conc.", bg='gray70',pch=21, xlim=c(1.735,1.85))
...
###### MC1 vs. MC6 - Bad 
REDO SPIN
```{r qpcr_5, fig.height=8,fig.width=8, dpi=300}
{
par(mfrow=c(2,2))
plot(MC1_T2.5$Corrected, MC1_T2.5$qPCR_RMAX,type="o", xlab="Buoyant Density - Lueders Corrected",
     ylab="Normalized RNA Conc.", bg='gray70',pch=21, xlim=c(1.735,1.85))
...
###### MC1 vs. MC4
```{r qpcr_3a, fig.height=8,fig.width=8, dpi=300}
{
par(mfrow=c(2,2))
...
```{r qpcr_4a, fig.height=8,fig.width=8, dpi=300}
{
par(mfrow=c(2,2))
plot(MC1_T3.5$Corrected, MC1_T3.5$qPCR_RMAX,type="o", xlab="Buoyant Density - Lueders Corrected",
     ylab="Normalized RNA Conc.", bg='gray70',pch=21)
...
```{r qpcr_5a, fig.height=8,fig.width=8, dpi=300}
{
par(mfrow=c(2,2))
plot(MC1_T3.5$Corrected, MC1_T3.5$qPCR_RMAX,type="o", xlab="Buoyant Density - Lueders Corrected",
     ylab="Normalized RNA Conc.", bg='gray70',pch=21)
