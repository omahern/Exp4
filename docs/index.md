...
plot(MC1$TP,MC1$Balanced_Atomic_.13C, type='o',  ylim=c(0,10542.03827),pch=21,bg='gray70',
...
plot(MC1c$TP,MC1c$Balanced_Atomic_.13C, type='o',  ylim=c(0,13424.45736),pch=21,bg='gray70',
     xlab="Time (days)", ylab="Atomic %13C", cex=1.5, cex.lab=1.4)
